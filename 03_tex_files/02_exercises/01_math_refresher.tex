...
State the general definition of expectation and variance for the probability density $f : \Omega \rightarrow \mathbb{R}$ of a continuous random variable. What do expectation and variance express?
}{
