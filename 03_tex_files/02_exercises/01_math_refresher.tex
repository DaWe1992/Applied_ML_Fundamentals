...
% Task 4
\exercise{Terminology (1 point)}{What is a random variable? What is a probability density function (PDF)? What is a probability mass function (PMF)? What do a PDF and a PMF tell us about a random variable?}{8.5cm}
