...
% Task 1
\exercise{ID3 Decision Tree Construction (3 points)}{You are given the following labeled dataset with the goal to construct a model for predicting when to choose which sport. Construct a decision tree using pen and paper with the information gain / entropy based splitting criterion. Constructing the first two levels of the tree is sufficient (i.\,e. performing the first split and one more split per attribute value of the first splitting attribute). Draw the tree and indicate each splitting attribute. Show your calculations.
\begin{center}
