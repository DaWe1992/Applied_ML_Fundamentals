...
Install it by running \cb{\texttt{pip install flair}}. Perform a 3-fold cross-validation and report precision and recall. Also, report your hyper-parameter configuration (learning rate, batch size, network structure, etc.).
}{
\vspace*{7cm}
}
