...
\begin{frame}{PCA Result}{}
	...
	\divideTwo{0.49}{
		\begin{figure}
			\centering
			\includegraphics[scale=0.30]{13_pca/02_img/pca_example_data_3d}
		\end{figure}
	}{0.49}{
		\begin{figure}
			\centering
			\includegraphics[scale=0.34]{13_pca/02_img/pca_example_eigenvectors}
		\end{figure}
	}
\end{frame}
...
\begin{frame}{PCA Result (Ctd.)}{}
	\begin{figure}
		\centering
		\includegraphics[scale=0.55]{13_pca/02_img/pca_example_data_2d}
	\end{figure}
\end{frame}
