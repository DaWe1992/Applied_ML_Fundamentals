\begin{figure}
	...
	\begin{tikzpicture}[scale=1.0]
		...
		\draw[->,thick] (A) -- node[left,align=left] {\footnotesize Choose matchbox \\[-1mm] \footnotesize according to position} (B);
		\draw[->,thick] (B) -- node[above,align=left] {\footnotesize Pick a marble \\[-1mm] \footnotesize from the matchbox} (C);
		\draw[->,thick] (C) -- node[right,align=left] {\footnotesize Execute move \\[-1mm] \footnotesize according to \\[-1mm] \footnotesize marble} (D);
