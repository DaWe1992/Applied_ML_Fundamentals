...
\begin{frame}{ECOCs: How to encode the classes?}{}
	\divideTwo{0.15}{
		\vspace*{5mm}
...
\begin{frame}{Recommended Literature and further Reading}{}
	...
	\begin{thebibliography}{2}
		\literature{book}{Hastie et al. 2008}{[2] The Elements of Statistical Learning}
		...
		\literature{online}{Dave Sotelo, Online Blog}{Using Bagging and Boosting to Improve Classification Tree Accuracy}{Dave Sotelo, Online Blog}{$\rightarrow$ \href{https://towardsdatascience.com/using-bagging-and-boosting-to-improve-classification-tree-accuracy-6d3bb6c95e5b}{\linkstyle{Link}}}
	\end{thebibliography}
\end{frame}
