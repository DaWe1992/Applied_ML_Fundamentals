...
\begin{frame}{Learning the Parameters}{}
	\begin{itemize}
		\item Learning means estimating the parameters $\bm{\theta}$ given the data $\bm{X}$
...
\begin{frame}{Generative vs. Discriminative Models}{}
	\divideTwo{0.47}{
		\highlight{Generative Model} \\ \textit{The artist}
		\begin{figure}
			\centering
			\includegraphics[scale=0.08]{04_density_estimation/02_img/artist}
		\end{figure}

		{\footnotesize A \textbf{generative} algorithm models \textbf{how} the data was generated.
		\Highlight{It models the respective probability distributions.}}
	}{0.47}{
		\highlight{Discriminative Model} \\ \textit{The lousy painter}
		\begin{figure}
			\centering
			\includegraphics[scale=0.28]{04_density_estimation/02_img/lousy_painter}
		\end{figure}
		
		{\footnotesize A \textbf{discriminative} algorithm does not care about how the data was generated.
		\Highlight{It only knows how to distinguish the classes.}}
	}
\end{frame}
