...
\begin{frame}{Introduction}{}
	\center\vspace{-0.3cm} Math is a significant portion of data science!\\
	\divideTwo{0.49}{
		\begin{figure}
			\centering
			\includegraphics[width=0.7\textwidth]{02_math/02_img/data_science.png}
		\end{figure}
	}{0.49}{
		\vspace{0.5cm}
		You will need it to understand:\newline\vspace{-0.6cm}
		\begin{itemize}\setlength\itemsep{0.05em}\small
			\item Assumptions about probability distributions,
			\item optimization for learning / empirical risk minimization,
			\item using linear algebra, calculus and statistics to make learning and inference more efficient
			\item and much more!
		\end{itemize}
	}
\end{frame}
