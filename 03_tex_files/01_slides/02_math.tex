...
\begin{frame}{Eigenvectors and Eigenvalues}{}\important
	\begin{itemize}
		...
		\end{equation*}
		\item These vectors are called \highlight{eigenvectors} of $\bm{X}$, the scaling factors are known as \highlight{eigenvalues} of $\bm{X}$
		\item More general:
		\begin{equation}
...
\begin{frame}{Eigenvectors form a Basis (Eigenbasis)}{}
	\begin{itemize}
...
\begin{frame}{Constrained Optimization}{}\important
	\begin{itemize}
		...
		\item This is done using \highlight{Lagrange multipliers} $\lambda$
	\end{itemize}
\end{frame}
...
\begin{frame}{Numerical Optimization Algorithms}{}
	\begin{itemize}
		...
		\begin{itemize}
			\item \highlight{Gradient descent} (with constant or variable step size $\alpha$)
		...
		\begin{itemize}
			\item \highlight{Genetic algorithms} (e.\,g. differential evolution)
