...
\begin{frame}
	...
	\dwTable{
		\begin{tabularx}{\textwidth}{ c | X | c }
			...
			\ding{182}			& 	Der Quellcode ist ausreichend kommentiert. 						& 	10 	\\ \hline
			\ding{183} 		&	Der Quellcode ist übersichtlich und ordentlich formatiert,
								intuitiv verständlich und folgt generell dem \textit{Clean Code} Ansatz.	&	40 	\\ \hline
			\ding{184} 		& 	Das gesamte Entwicklungsprojekt ist gut strukturiert und modular aufgebaut
								(z.\,B. Datenvorverarbeitung ist getrennt von Datenanalyse, etc.).		& 	40 	\\ \hline
			\ding{185} 		&	Das Projekt ist auf GitHub veröffentlicht und enthält
								eine aussagekräftige \texttt{README.md}.						& 	10 	\\ \hline\hline
...
\begin{frame}
	...
	\dwTable{
		\begin{tabularx}{\textwidth}{ c | X | c }
			...
			\ding{182} 		&	Der zeitliche Rahmen wurde eingehalten (20 min $\pm$ 3 min).		&	10	\\ \hline
			\ding{183}			& 	Die Präsentatoren haben nicht abgelesen und
								waren imstande, frei zu sprechen. 							& 	10 	\\ \hline
			\ding{184}			&	Die Geschwindigkeit des Vortrags war dem Inhalt angemessen.		& 	10	\\ \hline
			\ding{185}			&	Die Gruppenmitglieder konnten vom Publikum gestellte Fragen
								sicher beantworten.										&	20	\\ \hline
			\ding{186}			&	Der Vortrag ging auf alle relevanten Punkte ein. 					& 	15	\\ \hline
	...
	\dwTable{
		\begin{tabularx}{\textwidth}{ c | X | c }
			...
			\ding{182} 		& 	Der Projektreport liegt im richtigen Format vor
								(insbesondere Nutzung der \LaTeX-Vorlage und \texttt{*.pdf}-Format) 	& 	5 	\\ \hline
			\ding{183} 		& 	Der Projektreport bedient sich einer sachgerechten Sprache
								und ist verständlich verfasst.								& 	5 	\\ \hline
			\ding{184} 		& 	Der Vorgaben bezüglich des Seitenumfangs werden eingehalten.		& 	10	\\ \hline
			\ding{185} 		&	Der Projektreport ist klar und übersichtlich strukturiert.				&	10	\\ \hline
			\ding{186} 		&	Inhaltlich werden alle geforderten Bereiche abgedeckt.				& 	30 	\\ \hline
			\ding{187} 		& 	Der wirtschaftliche Kontext wird ausreichend herausgestellt.			&	10	\\ \hline
			\ding{188} 		& 	Die erzielten Ergebnisse werden kritisch reflektiert und bewertet.		& 	30 	\\ \hline\hline
			\multicolumn{2}{ l |}{\textbf{Summe}} 											& 	\textbf{100}
		\end{tabularx}
...
\begin{frame}
	\begin{itemize}
		...
		\begin{equation}
			\text{Note} = \frac{5}{10} \cdot \Sigma_{\text{Code}} + \frac{3}{10} \cdot \Sigma_{\text{Report}} +
				\frac{2}{10} \cdot \Sigma_{\text{Präsentation}}
		\end{equation}
