...
\begin{frame}
	...
	\dwAlertBox{Die komplette Abgabe besteht aus dem Projektreport (*.pdf), der Abschlusspräsentation (*.pdf), sowie dem im Rahmen des Projekts erstellten Quellcode. Der Quellcode ist auf einem öffentlichen GitHub Repository abzulegen.}
\end{frame}
