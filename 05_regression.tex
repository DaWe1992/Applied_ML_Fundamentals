...
\begin{frame}{Self-Test Questions}{}
	\begin{itemize}
	\item What is a suitable cost function for regression? Where does this cost function come from and which assumption(s) are there?
	\item What is regularization? Why should you apply it?
	\item What is maximum likelihood estimation?
	\item Which kinds of gradient descent algorithms do you know? Explain their differences.
	\item Which kinds of basis functions do you know? Why should basis functions be used? How to decide which basis functions to use?
	\item What is overfitting?
	\item Your model does not perform well, because of its high bias. Your boss suggests adding more training data. How would you respond?
	\end{itemize}
\end{frame}
...
\begin{frame}{Recommended Literature and further Reading}{}
	...
	\item Stanford CS229 course recording, Andrew Ng, \url{https://www.youtube.com/watch?v=5u4G23_OohI}
